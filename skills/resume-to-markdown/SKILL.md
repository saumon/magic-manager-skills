...
description: >-
  Convertit un CV (PDF ou Word) en Markdown en retirant la mise en forme
  (photo, images, logos, icones, colonnes, jauges) et en conservant
  l'integralite du texte dans l'ordre exact du document source. Le fichier
  produit porte le meme nom que la source, extension .md. Declencher pour
  "convertir un CV en markdown", "transformer ce CV en .md", "extraire le
  texte d'un CV", "alleger un CV". Ne pas declencher pour evaluer ou classer
  des candidats : c'est le role du skill resume-shortlist.
license: MIT
metadata:
  version: "1.0.2"
  author: "saumon"
